...
#pragma HLS INTERFACE s_axilite port=imageWidth bundle=CTRL
   ...
   // int pool_size = 2;
    ...
    fullyConnectedLayer(pool3Output,fully1output,dense1_weights,dense1_bias,12544,128,a_f2);
